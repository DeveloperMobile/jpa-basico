...
//        entityManager.getTransaction().commit();
        ...
        // 2 - Vamos utilizar o método do EntityManaer find(), SQL nativo, JPQL e JPA Criteria API para realizar uma
        // consulta que retornara o mesmo valor equivalente aos sequitnes SQL:
        ...
        // 2.2 - Utilizando o método find do entittymanater
        // Trazendo somente 1 resultado
//        Aluno alunoEntityManager = entityManager.find(Aluno.class, 2);
...
//        System.out.println("Consulta alunoEntityManager: " + alunoEntityManager);
       ...
       /* String sqlList = "SELECT * FROM aluno";
        ...
        alunoSQLList.forEach(Aluno -> System.out.println("Consulta alunoSQlList: " + Aluno.getNome()));*/

        // 2.4 - JPQL
        // Trazendo somente 1 resultado
        /*String jpql = "select a from Aluno a where a.nome = :nome";
        String ejpql = "select e from Estado e where e.nome = :nome";
        Estado estadoJPQL = entityManager
                .createQuery(ejpql, Estado.class)
...
*/
       ...
       /* String jpqlList = "select a from Aluno a where a.estado = :estado";
        List<Aluno> alunoJPQLList = entityManager
                ...
                .setParameter("estado", estadoJPQL)
                .getResultList();*/

        // Resultados das consultas acima
        /*System.out.println("Consulta alunoJPQL: " + alunoJPQL);
        alunoJPQLList.forEach(Aluno -> System.out.println("Consulta alunoJPQLList: " + Aluno.getNome()));*/
